...
def create_masks(path_to_video_file, output_frame_memmaps, output_frame_mask_memmaps):
    ...
    model = models.segmentation.deeplabv3_mobilenet_v3_medium(pretrained=True).eval()
...
# Example usage
create_masks('walking_10.mp4', 'walking.dat', 'walking_mask.dat')
# display_memmap_frames('walking.dat', num_frames=145, height=480, width=640)
display_memmap_frames('walking.dat', num_frames=250, height=1080, width=1920)
